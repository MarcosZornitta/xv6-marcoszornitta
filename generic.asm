...
_generic: formato do arquivo elf32-i386
...
int main(void){
  ...
  11:	e8 dc 02 00 00       	call   2f2 <getpid>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35f:	f7 f6                	div    %esi
 361:	0f b6 92 18 07 00 00 	movzbl 0x718(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4db:	b8 10 07 00 00       	mov    $0x710,%eax
...
00000560 <free>:
 560:	55                   	push   %ebp
 561:	a1 b0 09 00 00       	mov    0x9b0,%eax
 ...
 5b9:	a3 b0 09 00 00       	mov    %eax,0x9b0
 5be:	5b                   	pop    %ebx
 5bf:	5e                   	pop    %esi
 5c0:	5f                   	pop    %edi
 5c1:	5d                   	pop    %ebp
 ...
 5dd:	a3 b0 09 00 00       	mov    %eax,0x9b0
...
000005f0 <malloc>:
 ...
 5fc:	8b 15 b0 09 00 00    	mov    0x9b0,%edx
 ...
 651:	39 05 b0 09 00 00    	cmp    %eax,0x9b0
 ...
 67b:	8b 15 b0 09 00 00    	mov    0x9b0,%edx
 ...
 69f:	89 15 b0 09 00 00    	mov    %edx,0x9b0
 ...
 6b6:	c7 05 b0 09 00 00 b4 	movl   $0x9b4,0x9b0
 6bd:	09 00 00 
 6c0:	c7 05 b4 09 00 00 b4 	movl   $0x9b4,0x9b4
 6c7:	09 00 00 
 6ca:	b8 b4 09 00 00       	mov    $0x9b4,%eax
 6cf:	c7 05 b8 09 00 00 00 	movl   $0x0,0x9b8
 6d6:	00 00 00 
