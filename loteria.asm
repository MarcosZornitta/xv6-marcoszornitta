...
_loteria: formato do arquivo elf32-i386
...
int main(void)
{
  ...
  24:	e8 21 03 00 00       	call   34a <fork>
	if(pid > 0){
  29:	83 c4 10             	add    $0x10,%esp
  2c:	83 f8 00             	cmp    $0x0,%eax
  2f:	7e 5f                	jle    90 <main+0x90>
  ...
  47:	e8 fe 02 00 00       	call   34a <fork>
		if(pid > 0){
  4c:	83 c4 10             	add    $0x10,%esp
  4f:	83 f8 00             	cmp    $0x0,%eax
  52:	7e 3c                	jle    90 <main+0x90>
			printf(1, "Processo Pai: filho(2) = PID[%d], Bilhetes[%d]\n", pid, tickets2);
  54:	6a 64                	push   $0x64
  56:	50                   	push   %eax
  57:	68 08 08 00 00       	push   $0x808
  5c:	6a 01                	push   $0x1
  5e:	e8 3d 04 00 00       	call   4a0 <printf>
			pid = fork(tickets3);
  63:	c7 04 24 3c 00 00 00 	movl   $0x3c,(%esp)
  6a:	e8 db 02 00 00       	call   34a <fork>
			if(pid > 0){
  6f:	83 c4 10             	add    $0x10,%esp
  72:	83 f8 00             	cmp    $0x0,%eax
  75:	7e 19                	jle    90 <main+0x90>
				printf(1, "Processo Pai: filho(3) = PID[%d], Bilhetes[%d]\n", pid, tickets3);
  77:	6a 3c                	push   $0x3c
  79:	50                   	push   %eax
  7a:	68 38 08 00 00       	push   $0x838
  7f:	6a 01                	push   $0x1
  81:	e8 1a 04 00 00       	call   4a0 <printf>
  86:	83 c4 10             	add    $0x10,%esp
  89:	eb 07                	jmp    92 <main+0x92>
  8b:	90                   	nop
  8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			}else if(pid == 0){ consomeCPU(); }
  90:	74 29                	je     bb <main+0xbb>
		}else if(pid == 0){ consomeCPU(); }
	}else if(pid == 0){ consomeCPU(); }
	//Espero meus tres processos filhos terminarem
	wait();
  92:	e8 c3 02 00 00       	call   35a <wait>
	wait();
  97:	e8 be 02 00 00       	call   35a <wait>
	wait();
  9c:	e8 b9 02 00 00       	call   35a <wait>
	printf(1, "\n\tPai terminou! PID[%d]\n\n\t################# Fim #################\n\n", getpid());
  a1:	e8 2c 03 00 00       	call   3d2 <getpid>
  ...
  b1:	e8 ea 03 00 00       	call   4a0 <printf>
	...
	exit();
  b6:	e8 97 02 00 00       	call   352 <exit>
		if(pid > 0){
			printf(1, "Processo Pai: filho(2) = PID[%d], Bilhetes[%d]\n", pid, tickets2);
			pid = fork(tickets3);
			if(pid > 0){
  ...
  bb:	e8 00 00 00 00       	call   c0 <consomeCPU>
...
void consomeCPU(){
  ...
  c4:	56                   	push   %esi
  c5:	53                   	push   %ebx
  c6:	bf 64 00 00 00       	mov    $0x64,%edi
  cb:	83 ec 0c             	sub    $0xc,%esp
  ce:	be 64 00 00 00       	mov    $0x64,%esi
  d3:	90                   	nop
  d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  d8:	bb 64 00 00 00       	mov    $0x64,%ebx
  dd:	8d 76 00             	lea    0x0(%esi),%esi
	int i, j, k;
	for(i = 0; i < loop; i++){ for (j = 0; j < loop; ++j){ for (k = 0; k < loop; ++k) getpid();}}
  e0:	e8 ed 02 00 00       	call   3d2 <getpid>
  e5:	83 eb 01             	sub    $0x1,%ebx
  e8:	75 f6                	jne    e0 <consomeCPU+0x20>
  ea:	83 ee 01             	sub    $0x1,%esi
  ed:	75 e9                	jne    d8 <consomeCPU+0x18>
  ef:	83 ef 01             	sub    $0x1,%edi
  f2:	75 da                	jne    ce <consomeCPU+0xe>
	printf(1, "\n\tTerminei! PID[%d]\n", getpid());
  f4:	e8 d9 02 00 00       	call   3d2 <getpid>
  f9:	83 ec 04             	sub    $0x4,%esp
  fc:	50                   	push   %eax
  fd:	68 c0 07 00 00       	push   $0x7c0
 102:	6a 01                	push   $0x1
 104:	e8 97 03 00 00       	call   4a0 <printf>
	//Termino meu processo filho
	exit();
 109:	e8 44 02 00 00       	call   352 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 ac 08 00 00       	mov    $0x8ac,%eax
...
00000640 <free>:
 640:	55                   	push   %ebp
 641:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 ...
 699:	a3 6c 0b 00 00       	mov    %eax,0xb6c
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 6a1:	5d                   	pop    %ebp
 ...
 6bd:	a3 6c 0b 00 00       	mov    %eax,0xb6c
...
000006d0 <malloc>:
 ...
 6dc:	8b 15 6c 0b 00 00    	mov    0xb6c,%edx
 ...
 731:	39 05 6c 0b 00 00    	cmp    %eax,0xb6c
 ...
 75b:	8b 15 6c 0b 00 00    	mov    0xb6c,%edx
 ...
 796:	c7 05 6c 0b 00 00 70 	movl   $0xb70,0xb6c
 79d:	0b 00 00 
 7a0:	c7 05 70 0b 00 00 70 	movl   $0xb70,0xb70
 7a7:	0b 00 00 
 7aa:	b8 70 0b 00 00       	mov    $0xb70,%eax
 7af:	c7 05 74 0b 00 00 00 	movl   $0x0,0xb74
 7b6:	00 00 00 
