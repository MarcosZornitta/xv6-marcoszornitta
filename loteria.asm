...
_loteria:     file format elf32-i386
...
int main(void)
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	...
	pid = fork(tickets1);
  11:	6a 64                	push   $0x64
  13:	e8 22 03 00 00       	call   33a <fork>
	if(pid > 0){
  18:	83 c4 10             	add    $0x10,%esp
  1b:	83 f8 00             	cmp    $0x0,%eax
  1e:	7e 60                	jle    80 <main+0x80>
		printf(1, "Processo Pai: filho n.[1] - PID[%d], Bilhetes[%d]\n", pid, tickets1);
  20:	6a 64                	push   $0x64
  22:	50                   	push   %eax
  23:	68 c4 07 00 00       	push   $0x7c4
  28:	6a 01                	push   $0x1
  2a:	e8 61 04 00 00       	call   490 <printf>
		pid = fork(tickets2);
  2f:	c7 04 24 46 00 00 00 	movl   $0x46,(%esp)
  36:	e8 ff 02 00 00       	call   33a <fork>
		if(pid > 0){
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	83 f8 00             	cmp    $0x0,%eax
  41:	7e 3d                	jle    80 <main+0x80>
			printf(1, "Processo Pai: filho n.[2] - PID[%d], Bilhetes[%d]\n", pid, tickets2);
  43:	6a 46                	push   $0x46
  45:	50                   	push   %eax
  46:	68 f8 07 00 00       	push   $0x7f8
  4b:	6a 01                	push   $0x1
  4d:	e8 3e 04 00 00       	call   490 <printf>
			pid = fork(tickets3);
  52:	c7 04 24 3c 00 00 00 	movl   $0x3c,(%esp)
  59:	e8 dc 02 00 00       	call   33a <fork>
			if(pid > 0){
  5e:	83 c4 10             	add    $0x10,%esp
  61:	83 f8 00             	cmp    $0x0,%eax
  64:	7e 1a                	jle    80 <main+0x80>
				printf(1, "Processo Pai: filho n.[3] - PID[%d], Bilhetes[%d]\n", pid, tickets3);
  66:	6a 3c                	push   $0x3c
  68:	50                   	push   %eax
  69:	68 2c 08 00 00       	push   $0x82c
  6e:	6a 01                	push   $0x1
  70:	e8 1b 04 00 00       	call   490 <printf>
  75:	83 c4 10             	add    $0x10,%esp
  78:	eb 08                	jmp    82 <main+0x82>
  ...
  80:	74 29                	je     ab <main+0xab>
	...
	wait();
  82:	e8 c3 02 00 00       	call   34a <wait>
	wait();
  87:	e8 be 02 00 00       	call   34a <wait>
	wait();
  8c:	e8 b9 02 00 00       	call   34a <wait>
	printf(1, "\nPai terminou! PID[%d] -- Fim\n", getpid());
  91:	e8 2c 03 00 00       	call   3c2 <getpid>
  96:	83 ec 04             	sub    $0x4,%esp
  99:	50                   	push   %eax
  9a:	68 60 08 00 00       	push   $0x860
  9f:	6a 01                	push   $0x1
  ...
  ab:	e8 00 00 00 00       	call   b0 <consomeCPU>
...
void consomeCPU(){
  ...
  b4:	56                   	push   %esi
  b5:	53                   	push   %ebx
  b6:	bf c8 00 00 00       	mov    $0xc8,%edi
  bb:	83 ec 0c             	sub    $0xc,%esp
  be:	be c8 00 00 00       	mov    $0xc8,%esi
  c3:	90                   	nop
  c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  c8:	bb c8 00 00 00       	mov    $0xc8,%ebx
  cd:	8d 76 00             	lea    0x0(%esi),%esi
	int i, j, k;
	for(i = 0; i < loop; i++){ for (j = 0; j < loop; ++j){ for (k = 0; k < loop; ++k) getpid();}}
  d0:	e8 ed 02 00 00       	call   3c2 <getpid>
  d5:	83 eb 01             	sub    $0x1,%ebx
  d8:	75 f6                	jne    d0 <consomeCPU+0x20>
  da:	83 ee 01             	sub    $0x1,%esi
  dd:	75 e9                	jne    c8 <consomeCPU+0x18>
  df:	83 ef 01             	sub    $0x1,%edi
  e2:	75 da                	jne    be <consomeCPU+0xe>
	printf(1, "\nTerminei! PID[%d]\n", getpid());
  e4:	e8 d9 02 00 00       	call   3c2 <getpid>
  e9:	83 ec 04             	sub    $0x4,%esp
  ec:	50                   	push   %eax
  ed:	68 b0 07 00 00       	push   $0x7b0
  f2:	6a 01                	push   $0x1
  f4:	e8 97 03 00 00       	call   490 <printf>
	exit();
  f9:	e8 44 02 00 00       	call   342 <exit>
  fe:	66 90                	xchg   %ax,%ax
...
000003f0 <printint>:
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
...
00000490 <printf>:
 ...
 5ab:	b8 80 08 00 00       	mov    $0x880,%eax
...
00000630 <free>:
 ...
 689:	a3 40 0b 00 00       	mov    %eax,0xb40
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 691:	5d                   	pop    %ebp
 ...
 6ad:	a3 40 0b 00 00       	mov    %eax,0xb40
...
000006c0 <malloc>:
 ...
 6cc:	8b 15 40 0b 00 00    	mov    0xb40,%edx
 ...
 721:	39 05 40 0b 00 00    	cmp    %eax,0xb40
 ...
 74b:	8b 15 40 0b 00 00    	mov    0xb40,%edx
 ...
 786:	c7 05 40 0b 00 00 44 	movl   $0xb44,0xb40
 78d:	0b 00 00 
 790:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 797:	0b 00 00 
 79a:	b8 44 0b 00 00       	mov    $0xb44,%eax
 79f:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 7a6:	00 00 00 
